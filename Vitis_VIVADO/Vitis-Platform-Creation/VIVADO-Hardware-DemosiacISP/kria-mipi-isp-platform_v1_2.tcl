...
\
  ...
  set_property CONFIG.C_TOPOLOGY {3} $v_proc_ss_csc


  # Create instance: v_proc_ss_scalar, and set properties
  set v_proc_ss_scalar [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_proc_ss:2.3 v_proc_ss_scalar ]
  set_property CONFIG.C_TOPOLOGY {0} $v_proc_ss_scalar
  ...
  # Create instance: fan_en_b, and set properties
  set fan_en_b [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 fan_en_b ]
  set_property CONFIG.CONST_VAL {0} $fan_en_b
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins mipi_csi2_rx_subsyst_0/csirxss_s_axi] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins v_demosaic_0/s_axi_CTRL] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins v_gamma_lut_0/s_axi_CTRL] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins v_proc_ss_csc/s_axi_ctrl] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins v_proc_ss_scalar/s_axi_ctrl] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_iic_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  ...
  connect_bd_intf_net -intf_net v_proc_csc_m_axis [get_bd_intf_pins v_proc_ss_csc/m_axis] [get_bd_intf_pins v_proc_ss_scalar/s_axis]
  connect_bd_intf_net -intf_net v_proc_ss_0_m_axis [get_bd_intf_pins v_proc_ss_scalar/m_axis] [get_bd_intf_pins v_frmbuf_wr_0/s_axis_video]
  ...
  [get_bd_pins v_proc_ss_csc/aclk] \
  [get_bd_pins v_proc_ss_scalar/aclk_ctrl] \
  [get_bd_pins v_proc_ss_scalar/aclk_axis] \
  ...
  connect_bd_net -net fan_en_b_dout  [get_bd_pins fan_en_b/dout] \
  ...
  connect_bd_net -net v_demosaic_0_interrupt  [get_bd_pins v_demosaic_0/interrupt] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net v_frmbuf_wr_0_interrupt  [get_bd_pins v_frmbuf_wr_0/interrupt] \
  [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net v_gamma_lut_0_interrupt  [get_bd_pins v_gamma_lut_0/interrupt] \
  [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net xlconcat_0_dout  [get_bd_pins xlconcat_0/dout] \
  [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins rpi_cam_en/dout] \
  [get_bd_ports rpi_cam_en]
  ...
  [get_bd_pins v_proc_ss_csc/aresetn]
  connect_bd_net -net xlslice_3_Dout  [get_bd_pins xlslice_3/Dout] \
  [get_bd_pins v_proc_ss_scalar/aresetn_ctrl]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx_subsyst_0/csirxss_s_axi/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_demosaic_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_gamma_lut_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -with_name SEG_v_proc_csc_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_proc_ss_csc/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00040000 -with_name SEG_v_proc_ss_0_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_proc_ss_scalar/s_axi_ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  ...
  set_property PFM_NAME {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:kria_mipi_isp_platform:0.0} [get_files [current_bd_design].bd]
  set_property PFM.AXI_PORT {M_AXI_HPM0_FPD { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M_AXI_HPM1_FPD { memport "M_AXI_GP" sptag "" memory "" is_range "false" } S_AXI_HP0_FPD { memport "S_AXI_HP" sptag "HP0" memory "" is_range "false" } S_AXI_HP1_FPD { memport "S_AXI_HP" sptag "HP1" memory "" is_range "false" } S_AXI_HP2_FPD { memport "S_AXI_HP" sptag "HP2" memory "" is_range "false" } S_AXI_HP3_FPD { memport "S_AXI_HP" sptag "HP3" memory "" is_range "false" } S_AXI_HPC1_FPD { memport "S_AXI_HP" sptag "HPC1" memory "" is_range "false" } } [get_bd_cells /zynq_ultra_ps_e_0]
