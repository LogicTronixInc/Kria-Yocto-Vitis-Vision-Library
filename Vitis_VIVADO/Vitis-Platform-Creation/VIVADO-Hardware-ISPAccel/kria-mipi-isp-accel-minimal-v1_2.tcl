...
\
  ...
  connect_bd_intf_net -intf_net ISPPipeline_accel_0_m_axis_video [get_bd_intf_pins ISPPipeline_accel_0/m_axis_video] [get_bd_intf_pins v_proc_ss_scalar/s_axis]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins ISPPipeline_accel_0/s_axi_CTRL] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  ...
  connect_bd_intf_net -intf_net mipi_csi2_rx_subsyst_0_video_out [get_bd_intf_pins mipi_csi2_rx_subsyst_0/video_out] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net ISPPipeline_accel_0_interrupt  [get_bd_pins ISPPipeline_accel_0/interrupt] \
  ...
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x80040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  ...
  set_property PFM_NAME {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:kria-mipi-isp-accel-minimal-v1_2xsa_s212:0.0} [get_files [current_bd_design].bd]
